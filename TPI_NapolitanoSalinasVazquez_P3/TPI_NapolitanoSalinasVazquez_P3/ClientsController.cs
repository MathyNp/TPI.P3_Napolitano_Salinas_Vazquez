...
namespace TPI_NapolitanoSalinasVazquez_P3.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(TPI_NapolitanoSalinasVazquez_P3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Client != null ?
                        ...
                        Problem("Entity set 'TPI_NapolitanoSalinasVazquez_P3Context.Client'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("address,paymentMethod,userID,userName,userPassword,userMail,userRol")] Client client)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TPI_NapolitanoSalinasVazquez_P3Context.Client'  is null.");
            }
            var client = await _context.Client.FindAsync(id);
            if (client != null)
            {
